...
class AppTheme {
  ...
  // Trusted Wellness Palette - Healthcare optimized colors
  ...
  static const Color secondaryLight =
      Color(0xFF43A047); // Health-positive green
  static const Color secondaryVariantLight = Color(0xFF388E3C);
  static const Color backgroundLight =
      Color(0xFFFAFAFA); // Warm neutral background
  static const Color surfaceLight = Color(0xFFFFFFFF); // Clean card surfaces
  static const Color errorLight =
      Color(0xFFD32F2F); // Clear error communication
  static const Color warningLight = Color(0xFFF57C00); // Gentle guidance
  static const Color successLight = Color(0xFF388E3C); // Achievement feedback
  ...
  static const Color secondaryVariantDark = Color(0xFF43A047);
  ...
  static const Color dividerLight = Color(0xFFE0E0E0); // Minimal separation
  static const Color dividerDark = Color(0xFF424242);

  // Text colors for healthcare readability
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation for healthcare apps
    ...
    // Button themes for healthcare interactions
    ...
    // Typography for healthcare readability
    textTheme: _buildTextTheme(isLight: true),

    // Input decoration for health data forms
    ...
    // Slider theme for health metrics
    ...
    // Divider theme for minimal separation
